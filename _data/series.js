  ...
  groups: [
    {
      ...
      topics: [
        ...
        { num: 3, label: "ReentrantLock", title: "ReentrantLock", desc: "synchronized 대비 장점. tryLock, 인터럽트 가능, Condition 객체", x: 660, y: 220, status: "locked" },
    ...
    },
    {
      ...
      topics: [
        { num: 8, label: "ExecutorService", title: "ExecutorService", desc: "작업 제출 모델. Executors 팩토리의 함정. submit vs execute", x: 180, y: 280, status: "locked" },
...
const cardOnly = {
  ...
  network: { title: "네트워크", cardDesc: "TCP, HTTP, TLS, CORS, DNS", page: "network.html", done: 5, total: 12 },
