...
- [x] ★ Collection 비교 — ArrayList vs LinkedList, HashMap vs TreeMap (3편)
...
- [x] 4. `ReadWriteLock` / `StampedLock` — optimistic read (2편)

#### Group B — 락 없는 동시성 (보라)
- [x] ★ 5. CAS (Compare-And-Swap) — CPU 명령어, ABA 문제 (2편)
- [x] ★ 6. `Atomic*` 패밀리 — `AtomicInteger`부터 `LongAdder`까지 (2편)
...
- [x] ★ Rate Limiting 알고리즘 — Token / Leaky / Sliding (3편)
- [ ] ★ Circuit Breaker 보강 (기존 시리즈 확장)

### 운영/인프라
- [x] ★ Load Balancer — L4 vs L7 (2편)
- [x] ★ Reverse Proxy / API Gateway (3편)
- [x] ★ Graceful Shutdown 설계 (2편)

### 설계/아키텍처
- [x] ★ 멱등성 설계 패턴 (3편)
- [x] ★ REST 원칙과 RESTful 비판 — gRPC와의 비교 (3편)
- [x] ★ 모놀리스 vs MSA 트레이드오프 (3편)
